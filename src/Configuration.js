	...
	return (
		<Box sx={{ p: 1 }}>
			<Box component="form" sx={{ display:'flex', flexDirection: 'column'}}>
                ...
                <Box sx={{ height: 196, width: 1 }}></Box>
                <Box sx={{ display:'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                    <TextField sx={{ mr: 0.5 }} label="קו רוחב" variant="filled" type="number" value={lat} onChange={(e) => setLat(e.target.value)} />
                    <TextField sx={{ ml: 0.5 }} label="קו אורך" variant="filled" type="number" value={lon} onChange={(e) => setLon(e.target.value)} />
                </Box>
                ...
                <Box sx={{ mt: 1, display:'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                    <TextField sx={{ mr: 0.5 }} label="גופן זמנים" variant="filled" type="number" value={timesFontSize} onChange={(e) => setTimesFontSize(e.target.value)} />
                    <TextField sx={{ ml: 0.5 }} label="גופן הלכות" variant="filled" type="number" value={halachaFontSize} onChange={(e) => setHalachaFontSize(e.target.value)} />
                </Box>
